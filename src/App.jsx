...
const Icons = {
  ...
  Download: () => <svg xmlns="http://w3.org" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>,
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070709] text-zinc-100 antialiased selection:bg-red-500/20 selection:text-[#ff3131]">
      {/* Premium Glassmorphic Navigation Header Layout */}
